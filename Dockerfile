...
RUN apt-get update && apt-get install -y libssl-dev git && apt-get install -y libpq-dev git && apt-get install -y libxml2-dev git \
    ...
    R -e "devtools::install_github('ColoradoDemography/robR')" && \
